...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the gridAware analyzer + planner agents.")
    parser.add_argument(
        "--scenario",
    ...
    analyzer_result, planner_result = GridOrchestrator().run_planner(args.scenario)
    print(
        json.dumps(
            {
